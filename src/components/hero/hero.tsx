...
export const HeroSection = () => {
    return (
        <>
            <Slider loop>
                <HeroSlide buttonText='Saber más' buttonUrl='#' imageAlt='ASD' imageUrl="https://kioshistone.nyc3.digitaloceanspaces.com/kioshistone/Pagina-principal-1.jpg">
                ...
                <HeroSlide buttonText='Ver ensayos' buttonUrl='#' imageAlt='ASD' imageUrl="https://kioshistone.nyc3.digitaloceanspaces.com/kioshistone/Pagina-principal-2.jpg">
                ...
                <HeroSlide buttonText='Ver productos' buttonUrl='#' imageAlt='ASD' imageUrl="https://kioshistone.nyc3.digitaloceanspaces.com/kioshistone/Pagina-principal-3.jpg">
                ...
                <HeroSlide buttonText='Saber más' buttonUrl='#' imageAlt='ASD' imageUrl="https://kioshistone.nyc3.digitaloceanspaces.com/kioshistone/Pagina-principal-4.jpg">
